    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden bg-gradient-hero">
      ...
      <div className="relative z-10 container mx-auto px-4 flex flex-col lg:flex-row items-center justify-center gap-8 lg:gap-16">
        ...
        >
          ...
          >
            <button 
              className="group relative px-6 sm:px-8 py-4 bg-primary text-primary-foreground rounded-full font-medium shadow-rose hover:shadow-glow transition-all duration-300 overflow-hidden touch-manipulation min-h-[48px] text-sm sm:text-base"
              data-interactive
              onClick={() => {
            ...
            <button 
              className="px-6 sm:px-8 py-4 border-2 border-rose-soft text-rose-deep rounded-full font-medium hover:bg-rose-soft/20 transition-all duration-300 touch-manipulation min-h-[48px] text-sm sm:text-base"
              data-interactive
              onClick={() => {
